...
export default async function CartPage() {
  ...
  return <>
    <nav className="nav"><a className="nav-brand" href="/catalogo">Telas Xalostoc</a><a className="nav-link" href="/catalogo">Catálogo</a><a className="nav-link active" href="/carrito">Carrito</a><a className="nav-link" href="/pedidos">Mis pedidos</a><span className="nav-divider"/><LogoutButton/></nav>
